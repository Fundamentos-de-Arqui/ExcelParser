 ...
 * Se conecta a ActiveMQ usando JNDI lookup de WildFly
 */
@WebListener
    ...
    public void contextInitialized(ServletContextEvent sce) {
        synchronized (RealJMSListener.class) {
            ...
            try {
                ...
                // Intentar diferentes nombres JNDI comunes en WildFly
                jakarta.jms.ConnectionFactory connectionFactory = null;
                String[] jndiNames = {
                    "java:/jms/activemq/ConnectionFactory",  // Configurado por nosotros
