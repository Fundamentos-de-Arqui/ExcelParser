...
public class PatientJSONSenderService {
    ...
    private static final String PATIENT_DATA_QUEUE = "patient-data-queue";
    ...
    public boolean sendPatientDataToQueue(PatientProfile patientProfile) {
        try {
            ...
            System.out.println("=== COLA: " + PATIENT_DATA_QUEUE + " ===");
    ...
    private void initializeJMSConnection() throws JMSException {
        ...
        Queue queue = session.createQueue(PATIENT_DATA_QUEUE);
        ...
        System.out.println("✅ Conexión JMS inicializada para cola: " + PATIENT_DATA_QUEUE);
    }
