...
public class APIGatewayPublisherService {
    ...
    private static final String OUTPUT_QUEUE_NAME = "excel-generated-links";
    ...
    private void initJMSConnection() {
        try {
            ...
            Queue queue = session.createQueue(OUTPUT_QUEUE_NAME);
            System.out.println("✅ Cola creada: " + OUTPUT_QUEUE_NAME);
            
            producer = session.createProducer(queue);
            logger.info("APIGatewayPublisherService initialized and ready to publish to queue: " + OUTPUT_QUEUE_NAME);
            System.out.println("✅ APIGatewayPublisherService inicializado correctamente");
            System.out.println("   Cola destino: " + OUTPUT_QUEUE_NAME);
    ...
    public boolean sendExcelLinkToAPIGateway(String downloadUrl, String fileName, String messageId) {
        try {
            ...
            System.out.println("Cola: " + OUTPUT_QUEUE_NAME);
