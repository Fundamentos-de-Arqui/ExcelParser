...
import com.soulware.platform.docexcelparser.application.service.PatientDataService;
...
public class JMSConfig {
    ...
    public void init() {
        try {
            ...
            brokerUrl = config.getJmsBrokerHttpUrl();
            queueName = config.getJmsQueueExcelInputAlt();
    ...
    public List<String> readMessages() {
        ...
        try {
            ...
            conn.setRequestProperty("Origin", "http://" + serverHost + ":" + serverPort);
            conn.setRequestProperty("User-Agent", "DocExcelParser/1.0");
            conn.setRequestProperty("Referer", "http://" + serverHost + ":" + serverPort);
