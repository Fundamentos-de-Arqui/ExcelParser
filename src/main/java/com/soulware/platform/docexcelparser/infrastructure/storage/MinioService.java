package com.soulware.platform.docexcelparser.infrastructure.storage;
...
import com.soulware.platform.docexcelparser.domain.service.IFileStorageService; // AGREGAR
...
public class MinioService implements IFileStorageService{
    ...
    public void deleteFile(String key) throws IOException {
        try {
            ...
            throw new IOException("Failed to delete file " + key + ": " + e.getMessage(), e);
        }
    }
     ...
     */
    @Override
    public IFileStorageService.FileInfo getFileInfo(String key) {
        try {
            HeadObjectRequest headObjectRequest = HeadObjectRequest.builder()
                    .bucket(bucketName)
                    .key(key)
            ...
            // Convertir java.time.Instant a String
            String lastModifiedStr = response.lastModified() != null ?
                    response.lastModified().toString() : "";

            // Retornar el tipo de la interfaz
            return new IFileStorageService.FileInfo(
